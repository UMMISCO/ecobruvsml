...
write.csv(auc_acc_species_prev_10.df, file="/data/projects/aime/analyses/metabarcoding/4.data_video_analysis/1.Article_figures/fig2/fig2-B-C-E-F/auc_acc_species_prev_10.csv")
...
pdf(file="/data/projects/aime/analyses/bruvs/Figure4/Figure4.pdf", h=12, w=15)
