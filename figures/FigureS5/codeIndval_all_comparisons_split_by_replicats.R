# To run this script, use this command: Rscript codeIndval_all_comparisons_split_by_replicats.R 10 MBERE ABORE
...
save_path_indval <- '/data/projects/aime/analyses/bruvs/results_replicas_analysis/Indval_output_data/'
