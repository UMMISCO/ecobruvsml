...
# Purpose: Generate Figure S3 - Indicator species overview at 10% prevalence
#          comparing IndVal, bininter, and terinter methods with Venn diagrams
#          and barplots.
...
# Outputs: Figures/FigureS3/FigS3.pdf
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/FigureS3
# Rscript FigureS3_code.R
# -----------------------------------------------------------------------------
...
dir.create(file.path(base_dir, "analyses", "Figures", "FigureS3"), showWarnings = FALSE, recursive = TRUE)
...
pdf(file=file.path(base_dir, "analyses", "Figures", "FigureS3", "FigS3.pdf"), h=15, w=25)
fbm.plot
dev.off()
