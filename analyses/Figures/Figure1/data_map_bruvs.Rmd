---
title: "Figure 1 - BRUVS Sampling Site Map and Heatmap of Species Abundance"
...
<!--
Purpose:  Updated version of Figure 1 (Estephe Kana revision) - geographic map
          of BRUVS sampling locations with habitat color-coding and improved layout.
Inputs:   data/AllDataexportefixed.txt
Outputs:  analyses/Figures/Figure1/Figure1_EK.pdf
Run:      Rscript -e "rmarkdown::render('data_map_bruvs.Rmd')"
-->
...
env_bruvs_df <- as.data.frame(read.csv(file.path(base_dir, "data", "environmental_data_lagoon_2016_60_samples.csv"), sep = ";"))
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure1", "mapview_env_bruvs.pdf"), h=6, w=9)
p1
dev.off()
...
load(file = file.path(base_dir, "data", "video_data_object_pres_abs.rda"))
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure1", "Figure1_addNMDS.pdf"), h=9, w=16)
