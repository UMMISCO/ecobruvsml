# =============================================================================
# Script name: rf_video_analysis_by_replicas_BestModels_Predomics.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Run Random Forest classification using best model species from
#          Predomics (bininter/terinter) on replica-split BRUVS data.
#          Evaluates AUC, accuracy, and F1 metrics on test sets.
# Inputs:  Figures/FigureS5/results_replicas_analysis/all_analysis_results_split_replicas.Rda
# Outputs: Figures/FigureS5/results_replicas_analysis/all_analysis_results_split_replicas_BestModels_Predomics.Rda
#          Figures/FigureS5/results_replicas_analysis/all_species_analysis_split_by_replicas_BestModels_Predomics.csv
#          Figures/FigureS5/results_replicas_analysis/indics_species_analysis_split_by_replicas_BestModels_Predomics.csv
#          Figures/FigureS5/rf_analysis_by_replicas/rf_analysis_results_split_by_replicas_BestModel_Predomics.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/FigureS5
# Rscript rf_video_analysis_by_replicas_BestModels_Predomics.R
# -----------------------------------------------------------------------------
...
save(rf.metrics.bestModel.df, file = file.path(base_dir, "analyses", "Figures", "FigureS5", "rf_analysis_by_replicas", "rf_analysis_results_split_by_replicas_BestModel_Predomics.Rda"))
