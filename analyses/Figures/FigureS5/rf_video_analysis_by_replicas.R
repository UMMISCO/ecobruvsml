# =============================================================================
# Script name: rf_video_analysis_by_replicas.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Run Random Forest classification using indicator species identified
#          by IndVal and Predomics methods on replica-split BRUVS data.
...
# Outputs: Figures/FigureS5/rf_analysis_by_replicas/rf_analysis_results_split_by_replicas.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/FigureS5
# Rscript rf_video_analysis_by_replicas.R
# -----------------------------------------------------------------------------
...
load(file.path(base_dir, "analyses", "Figures", "FigureS5", "results_replicas_analysis", "all_analysis_results_split_replicas.Rda"))
...
# save rf results
save(rf.metrics.df, file = file.path(base_dir, "analyses", "Figures", "FigureS5", "rf_analysis_by_replicas", "rf_analysis_results_split_by_replicas.Rda"))
