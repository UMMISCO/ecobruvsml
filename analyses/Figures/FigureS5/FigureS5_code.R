# =============================================================================
# Script name: FigureS5_code.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Generate Figure S5 - generalization performance comparison (AUC,
#          Accuracy, F1) across methods (IndVal, Predomics, RF) using
#          replica-split validation (ABORE train / MBERE test).
# Inputs:  analyses/analysis_outputs/replicas_analysis_results/all_analysis_results_split_replicas.Rda
#          analyses/analysis_outputs/rf_analysis_by_replicas/*.Rda
# Outputs: analyses/Figures/FigureS5/FigureS5_Best.pdf
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/FigureS5
# Rscript FigureS5_code.R
# -----------------------------------------------------------------------------
...
load(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "results_replicas_analysis", "all_analysis_results_split_replicas.Rda"))
...
load(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "rf_analysis_by_replicas", "rf_analysis_results_split_by_replicas.Rda"))
...
indics_species.df <- read.csv(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "results_replicas_analysis", "indics_species_analysis_split_by_replicas.csv"))

# load indics species result table for replicas analysis with Best models of bininter/terinter
indics_species_BM.df <- read.csv(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "results_replicas_analysis", "indics_species_analysis_split_by_replicas_BestModels_Predomics.csv"))
...
pdf(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "FigureS5_Best.pdf"), h=13, w=11)
hlay="
A
A
B
...
pdf(file = file.path(base_dir, "analyses", "Figures", "FigureS5", "FigureS5_Best_update.pdf"), h=22, w=15)
hlay="
AAAA
BBCC
BBCC
