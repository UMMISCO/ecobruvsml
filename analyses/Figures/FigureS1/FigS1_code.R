# =============================================================================
# Script name: FigS1_code.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2025-02-21
# Purpose: Generate Figure S1 - Indicator species overview comparing IndVal,
#          bininter, and terinter methods with Venn diagrams, barplots,
#          and AUC violin plots across prevalence thresholds.
...
# Outputs: Figures/FigureS1/FigS1.pdf
#          Figures/FigureS1/FigS1_v2.pdf
#          Figures/FigureS1/FigureS1_Best.pdf
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/FigureS1
# Rscript FigS1_code.R
# -----------------------------------------------------------------------------
...
dir.create(file.path(base_dir, "analyses", "Figures", "FigureS1"), showWarnings = FALSE, recursive = TRUE)
...
hlay <- rbind(c(1,2,3),
              ...
              c(4,4,4),
              c(4,4,4))
pdf(file=file.path(base_dir, "analyses", "Figures", "FigureS1", "FigS1.pdf"), h=10, w=10)
...
hlay <- rbind(c(1,2,3,4),
              ...
              c(5,5,5,5),
              c(5,5,5,5))
pdf(file=file.path(base_dir, "analyses", "Figures", "FigureS1", "FigS1_v2.pdf"), h=10, w=10)
grid.arrange(plots.list$INSHORE_OFFSHORE$barplot + ggtitle("A"),
...
pdf(file=file.path(base_dir, "analyses", "Figures", "FigureS1", "FigureS1_Best.pdf"), h=10, w=10)
grid.arrange(plots.list$INSHORE_OFFSHORE$barplot + ggtitle("A"),
             plots.list$INSHORE_OFFSHORE$vennDiagrams$maxN + ggtitle("B"),
             nullGrob(),
             plots.list$INSHORE_OFFSHORE$vennDiagrams$`pres/abs` + ggtitle("C"),
