...
# Purpose: Generate Figure 5 (updated EK version) - Performance metrics,
#          radar plots, heatmaps, and AUC comparisons for 80/20 split analysis
#          using Predomics and IndVal methods.
# Inputs:  analysis_outputs/all_analysis_results_80_20.Rda
#          analysis_outputs/rf_analysis_results_80_20.Rda
#          analysis_outputs/indics_species_analysis_results_80_20.csv
#          analysis_outputs/video_data_object.rda
# Outputs: Figures/Figure5_S4_S6/Figure5_old.pdf
#          Figures/Figure5_S4_S6/FigureS6.pdf
#          Figures/Figure5_S4_S6/FigureS4.pdf
#          Figures/Figure5_S4_S6/Figure5_AddRadar_plot.pdf
#          Figures/Figure5_S4_S6/Radar_plot.pdf
#          Figures/Figure5_S4_S6/Radar_plot_update.pdf
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/Figure5_S4_S6
# Rscript Figure5_code.R
# -----------------------------------------------------------------------------
...
load(file = file.path(base_dir, "analyses", "analysis_outputs", "all_analysis_results_80_20.Rda"))
...
load(file = file.path(base_dir, "analyses", "analysis_outputs", "rf_analysis_results_80_20.Rda"))
...
load(file.path(base_dir, "analyses", "analysis_outputs", "all_analysis_results_80_20.Rda"))
...
indics_species.df <- read.csv(file=file.path(base_dir, "analyses", "analysis_outputs", "indics_species_analysis_results_80_20.csv"))
...
g3 <-wrap_plots(x.plots$INSHORE_OFFSHORE$seed_01 + theme(axis.title.x = element_blank(), legend.position = "none", axis.title.y = element_blank(), strip.background.y = element_rect(fill = NA, linetype = 0), strip.text.y = element_blank()),
                ...
                ncol=1)
# save the Figure 5
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "Figure5_old.pdf"), h=8, w=16)
hlay="
AAAACC
AAAACC
BBBBCC
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "FigureS6.pdf"), h=12, w=12)
hlay2="
A
A
B
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "FigureS4.pdf"), h=8, w=16)
hlay3=
  "
AABBCC
AABBCC
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "Figure5_AddRadar_plot.pdf"), h=14, w=20)
hlay4="
AACC
AACC
BBCC
...
# save only radar plots
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "Radar_plot.pdf"), h=6, w=19)
hlay5="
AABB
AABB
"
wrap_plots(wrap_elements(p1 + guides(color = "none", fill = "none")) + xlim(0, 100) + ylim(0, 50),
           wrap_elements(p2  +
                           theme(
                             legend.position = "right",
                             legend.title = element_text(size = 10),
                             legend.text  = element_text(size = 8),
                             legend.key.size = unit(0.5, "cm")))+ xlim(0, 100) + ylim(0, 50), 
           design = hlay5)
dev.off()

library(gridExtra)

pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "Radar_plot_update.pdf"),
    h=4, w=12)

# Modify p1 (remove legend)
p1_mod <- p1 +
  guides(color = "none", fill = "none") 

# Modify p2 (small legend on right)
p2_mod <- p2 +
  theme(
    legend.position = "right",
    legend.title = element_text(size = 10),
...
# Arrange in a 2 ?? 2 layout (AABB equivalent)
grid.arrange(
  p1_mod,
  p2_mod,
  ncol = 2,
