# =============================================================================
# Script name: Figure5_S4_S6_code.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2025-01-01
# Purpose: Generate Figures S4 and S6 (and updated Figure 5 radar plot) with
#          Twinspan method included - performance comparisons (AUC), radar plots,
#          and heatmaps for 80/20 split analysis.
# Inputs:  analysis_outputs/all_analysis_results_with_twinspan_80_20.Rda
#          analysis_outputs/rf_analysis_results_with_twinspan_80_20.Rda
#          analysis_outputs/indics_species_analysis_results_80_20_with_twinspan.csv
#          analysis_outputs/video_data_object.rda
# Outputs: Figures/Figure5_S4_S6/FigureS6_with_twinspan.pdf
#          Figures/Figure5_S4_S6/FigureS4_with_twinspan.pdf
#          Figures/Figure5_S4_S6/Figure5_AddRadar_plot_with_twinspan.pdf
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/Figures/Figure5_S4_S6
# Rscript Figure5_S4_S6_code.R
# -----------------------------------------------------------------------------
...
load(file = file.path(base_dir, "analyses", "analysis_outputs", "all_analysis_results_with_twinspan_80_20.Rda"))
...
load(file = file.path(base_dir, "analyses", "analysis_outputs", "rf_analysis_results_with_twinspan_80_20.Rda"))
...
# factorize methods
metrics.df$method <- factor(metrics.df$method, levels = c("BestModel_bininter", "BestModel_terinter", "RF_bininter","RF_Indval", "RF_terinter", "RF_Twinspan"))
...
indics_species.df <- read.csv(file=file.path(base_dir, "analyses", "analysis_outputs", "indics_species_analysis_results_80_20_with_twinspan.csv"))

# Helper function for generating Venn diagrams
generate_venn_plot <- function(venn_data, title_text, set_size = 3, colors=scale_color_viridis_d()) {
  ...
  ggvenn(venn_data,fill_color = colors, 
         show_stats = "c", stroke_size = 0.5, set_name_size = set_size, stroke_alpha = 1, padding = 0.2) + 
    ggtitle(title_text) +
...
g3 <-wrap_plots(x.plots$INSHORE_OFFSHORE$seed_01 + theme(axis.title.x = element_blank(), legend.position = "none", axis.title.y = element_blank(), strip.background.y = element_rect(fill = NA, linetype = 0), strip.text.y = element_blank()),
                ...
                ncol=1)
# # save the Figure 5
# pdf(file="~/Downloads/Bruvs-analysis-code_update_25022026/Bruvs-analysis-code/analyses/Figure5_Update_EK/Figure5_old_with_twinspan.pdf", h=8, w=16)
# hlay="
# AAAACC
# AAAACC
# BBBBCC
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "FigureS6_with_twinspan.pdf"), h=12, w=12)
hlay2="
A
A
B
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "FigureS4_with_twinspan.pdf"), h=8, w=16)
hlay3=
  "
AABBCC
AABBCC
...
compute_mean <- function(subdt, var) {
  mean_subdt.df <- subdt %>%
    ...
    dplyr::summarise(mean_value = mean(.data[[var]], na.rm = TRUE), .groups = "drop")
  out <- reshape2::dcast(mean_subdt.df, method ~ comparison + source, value.var = "mean_value")
  data.table::setnames(out, "method", "group")
...
# Define colors
colors_border <- c("#9467bd", "#FA56BB", "#648C67", "#8195B2", "#CC3837", "#ff7f0e")
...
pdf(file=file.path(base_dir, "analyses", "Figures", "Figure5_S4_S6", "Figure5_AddRadar_plot_with_twinspan.pdf"), h=14, w=20)
hlay4="
AACC
AACC
BBCC
