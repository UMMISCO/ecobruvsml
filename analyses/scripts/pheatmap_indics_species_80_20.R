# =============================================================================
# Script name: pheatmap_indics_species_80_20.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Generate heatmaps visualizing indicator species identified across all methods (IndVal, Predomics, TWINSPAN) and habitat comparisons from 80/20 split data.
# Inputs:  analyses/analysis_outputs/all_analysis_results_80_20.Rda, analyses/analysis_outputs/indics_species_analysis_results_80_20.csv
# Outputs: PDF heatmaps in analyses/Figures/
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript pheatmap_indics_species_80_20.R
# -----------------------------------------------------------------------------
