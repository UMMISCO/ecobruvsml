# =============================================================================
# Script name: codeIndval_all_analyses_prev.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-06-01
# Purpose: Perform Indicator Species Analysis (IndVal) with prevalence filtering on complete BRUVS dataset for all pairwise habitat comparisons, using MaxN and presence/absence data.
# Inputs:  data/AllDataexportefixed.txt; command-line arg: prevalence_rate (%)
# Outputs: analyses/analysis_outputs/Indval_output_data/Indval_all_analyses_overall_data_prev_{rate}.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript codeIndval_all_analyses_prev.R 10
# -----------------------------------------------------------------------------
...
##### Save the datasets
save_path <- file.path(base_dir, "analyses", "analysis_outputs", "Indval_output_data") 
save(adonis.bin, #adonis results all comparisons; binary data
     ...
     indvalout.maxn, 
     indvalout.bin.sub, 
     indvalout.maxn.sub, file = file.path(save_path, paste("Indval_all_analyses_overall_data", "prev", paste0(prevalence_rate,".Rda"), sep = "_")))