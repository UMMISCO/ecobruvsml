# =============================================================================
# Script name: codeIndval_all_analyses_split_data.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-09-01
# Purpose: Perform Indicator Species Analysis (IndVal) with 80/20 stratified train/test split across multiple seeds, using MaxN and presence/absence data.
# Inputs:  data/AllDataexportefixed.txt; args: prevalence_rate (%), maxseed
# Outputs: analyses/analysis_outputs/Indval_output_data/analysis_80_20/Indval_all_analyses_split_80_20_data_prev_{rate}_seed_{n}.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript codeIndval_all_analyses_split_data.R 10 10
# -----------------------------------------------------------------------------
...
for (seed in 1:maxseed) {
  ...
  save_path_indval <- file.path(base_dir, "analyses", "analysis_outputs", "Indval_output_data", "analysis_80_20")
