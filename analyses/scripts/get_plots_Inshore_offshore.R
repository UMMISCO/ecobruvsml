# =============================================================================
# Script name: get_plots_Inshore_offshore.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-09-01
# Purpose: Generate publication figures comparing INSHORE vs OFFSHORE indicator species results (PERMANOVA, feature importance) from overall dataset (no prevalence filter).
...
# Rscript get_plots_Inshore_offshore.R
# -----------------------------------------------------------------------------
...
load(file=file.path(base_dir, "analyses", "analysis_outputs", "Indval_output_data", "Indval_all_analyses_overall_data_prev_0.Rda"))
adonis_indval.bin <- adonis.bin; adonis_indval.maxn <- adonis.maxn

# load bininter results
load(file=file.path(base_dir, "analyses", "analysis_outputs", "bininter_output_data", "bininter_Predomics_all_analyses_overall_data_prev_0.Rda"))
...
load(file=file.path(base_dir, "analyses", "analysis_outputs", "terinter_output_data", "terinter_Predomics_all_analyses_overall_data_prev_0.Rda"))
# Rename variables loaded to diffenriate it with terinter vars
...
load(file=file.path(base_dir, "analyses", "analysis_outputs", "twinspan_output_data", "Twinspan_all_analyses_overall_data_prev_0.Rda"))
...
write.csv(auc_acc_all_species.df, file=file.path(base_dir, "analyses", "analysis_outputs", "auc_acc_all_species.csv"))
...
auc_acc_all_species.df <- read.csv(file = file.path(base_dir, "analyses", "analysis_outputs", "auc_acc_all_species.csv"))

# import dataframe of auc and acc performances for species with at least 10% of prevalence
auc_acc_species_prev_10.df <- read.csv(file=file.path(base_dir, "analyses", "analysis_outputs", "auc_acc_species_prev_10.csv"))
