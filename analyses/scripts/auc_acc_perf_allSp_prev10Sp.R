# =============================================================================
# Script name: auc_acc_perf_allSp_prev10Sp.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Compare AUC/accuracy performance of Predomics models between all-species and prevalence-filtered (10%) species sets, with violin plots and Wilcoxon tests.
# Inputs:  analyses/analysis_outputs/auc_acc_all_species.csv, analyses/analysis_outputs/auc_acc_species_prev_10.csv
...
# Rscript auc_acc_perf_allSp_prev10Sp.R
# -----------------------------------------------------------------------------
