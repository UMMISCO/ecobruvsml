# =============================================================================
# Script name: best_model_evaluation_test_data_all_80_20.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-12-01
# Purpose: Evaluate best Predomics models on hold-out test data (20%) across all seeds, comparisons, and algorithms.
# Inputs:  analyses/analysis_outputs/all_analysis_results_80_20.Rda
# Outputs: analyses/analysis_outputs/best_model_test_evaluation_results.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript best_model_evaluation_test_data_all_80_20.R
# -----------------------------------------------------------------------------
