...
<!--
Purpose:  Generate all publication figures combining IndVal, Predomics, and TWINSPAN results.
Inputs:   analyses/analysis_outputs/ (multiple .Rda and .csv files)
Outputs:  PDF plots in analyses/Figures/, CSV files in analyses/analysis_outputs/
Run:      Open in RStudio and knit, or: Rscript -e "rmarkdown::render('get_plots.Rmd')"
-->
...
##### Save objects
save_path <- file.path(base_dir, "analyses", "analysis_outputs")
...
all_species.df <- as.data.frame(read.csv(file.path(base_dir, "analyses", "analysis_outputs", "feat_import_all_analyses__overall_data_prev_1O.csv")))
