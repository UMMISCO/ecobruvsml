# =============================================================================
# Script name: codePredomics_all_analyses.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-06-01
# Purpose: Run Predomics (TerBeam) classification with 80/20 train/test split across seeds, for all pairwise habitat comparisons using MaxN and presence/absence data.
# Inputs:  data/AllDataexportefixed.txt; args: algorithm_language (terinter|bininter), prevalence_rate, max_seed
# Outputs: analyses/analysis_outputs/{algorithm}_output_data/{algorithm}_Predomics_all_analyses_final.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript codePredomics_all_analyses.R terinter 0 1
# -----------------------------------------------------------------------------
...
for (seed in 1:max_seed) {
  ...
  save(adonis_pred.bin, #adonis results all comparisons; binary data
       ...
       predout.maxn,
       predout.bin.sub,
       predout.maxn.sub, file = file.path(save_path, paste(algorithm_language, "Predomics_all_analyses_final.Rda", sep = "_")))
