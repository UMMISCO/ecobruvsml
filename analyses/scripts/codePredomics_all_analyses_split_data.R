# =============================================================================
# Script name: codePredomics_all_analyses_split_data.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-09-01
# Purpose: Run Predomics (TerBeam) classification split by field replica groups (ABORE vs MBERE) for generalization testing.
# Inputs:  data/AllDataexportefixed.txt; args: algorithm_language (terinter|bininter), prevalence_rate (%)
# Outputs: analyses/analysis_outputs/{algorithm}_output_data/analysis_by_replicas/
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript codePredomics_all_analyses_split_data.R terinter 10
# -----------------------------------------------------------------------------
...
save_path_pred <- file.path(base_dir, "analyses", "analysis_outputs", paste0(algorithm_language, "_output_data"), "analysis_by_replicas")
...
file_path <- file.path(save_path_pred, paste0(algorithm_language, "_Predomics_all_comparison_replicas_prev_", prevalence_rate, ".Rda"))
