# =============================================================================
# Script name: get_plots_Inshore_Offshore_prev_10.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-09-01
# Purpose: Generate publication figures comparing INSHORE vs OFFSHORE indicator species results from prevalence-filtered (10%) dataset.
# Inputs:  analyses/analysis_outputs/Indval_output_data/, analyses/analysis_outputs/bininter_output_data/, analyses/analysis_outputs/terinter_output_data/
# Outputs: PDF plots in analyses/Figures/
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript get_plots_Inshore_Offshore_prev_10.R
# -----------------------------------------------------------------------------
...
#pdf(file=file.path(base_dir, "analyses", "Figures", "permanova_all_results_updated_final.pdf"), h=6, w=7)
...
#pdf(file=file.path(base_dir, "analyses", "Figures", "permanova_ratio_all_results_final.pdf"), h=6, w=7)
...
auc_acc_species_prev_10.df$# Define project base directory (adjust if running from a different location)

dataset <- "species_prev_10"
