# =============================================================================
# Script name: codePredomics_all_analyses_overall_data_prev.R
# Author: Estephe Kana, Eugeni Belda, Edi Prifti
# Date created: 2024-09-01
# Purpose: Run Predomics (TerBeam) classification on complete dataset with prevalence filtering for all pairwise habitat comparisons, using MaxN and presence/absence data.
# Inputs:  data/AllDataexportefixed.txt; args: algorithm_language (terinter|bininter), prevalence_rate (%)
# Outputs: analyses/analysis_outputs/{algorithm}_output_data/{algorithm}_Predomics_all_analyses_overall_data_prev_{rate}.Rda
# =============================================================================

# -----------------------------------------------------------------------------
# Commands to run the script:
# cd /home/estephe/Documents/Papers/2026-aime_key_fish_bruvs/Bruvs-analysis-code/analyses/scripts
# Rscript codePredomics_all_analyses_overall_data_prev.R terinter 10
# -----------------------------------------------------------------------------
...
#### Save the datasets
save_path <- file.path(base_dir, "analyses", "analysis_outputs", paste0(algorithm_language, "_output_data"))  
save(adonis_pred.bin, #adonis results all comparisons; binary data
     ...
     predout.maxn,
     predout.bin.sub,
     predout.maxn.sub, file = file.path(save_path, paste(algorithm_language, "Predomics_all_analyses_overall_data", "prev", paste0(prevalence_rate,".Rda"), sep = "_")))
